...
public class IndieFragment extends Fragment {
    ...
    public static IndieFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_indie, container, false);
        gridView=root.findViewById(R.id.indieFragment);
        fStore = FirebaseFirestore.getInstance();
        path = "/content/games/Indie";
